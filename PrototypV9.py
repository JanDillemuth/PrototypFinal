...
# Finaler Stand: Native Streamlit-Container, San Francisco Font & Grüne Akzente
# =============================================================================
...
<style>
    ...
    /* Sekundäre Buttons (z.B. Logout, Zurück) */
    ...
    /* -------------------------------------------------------------
       NATIVE STREAMLIT CONTAINER STYLING (LÖST DAS BOXEN-PROBLEM)
    ...
    /* Schönere, verblassende Trennlinien (Grüner Verlauf) anstelle der grauen Linie */
    hr { 
        border: 0 !important; 
...
# =============================================================================
# ABSCHNITT 3: SESSION STATE INITIALISIERUNG
# =============================================================================
def init_session():
    defaults = {
        "eingeloggt": False,
...
def update_ticket_status(ticket_id, selectbox_key):
...
if st.session_state.aktuelle_seite == "profil":
    ...
    with col_prof1:
        # HIER WIRD NUN NATIVE STREAMLIT CONTAINER GENUTZT
                    ...
                    for tk in reversed(st.session_state.tickets):
                        with st.container(border=True):
                            ...
                            with col_t1:
                                ...
                                # Konsistente Benennung passend zum Dropdown-Menü
                                if tk['status'] == "Offen":
